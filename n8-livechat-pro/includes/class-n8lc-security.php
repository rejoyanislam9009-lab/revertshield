...
final class N8LC_Security {
    ...
    public static function sanitize_custom_data( $value ) {
        if ( ! is_array( $value ) ) {
            return array();
        }
        $clean = array();
    ...
    public static function settings_permission() {
    ...
    public static function tag_permission() {
        return current_user_can( 'n8lc_manage_tags' ) || current_user_can( 'manage_options' );
    }

    public static function export_permission() {
        return current_user_can( 'n8lc_export_chat' ) || current_user_can( 'manage_options' );
    }
    ...
    public static function allowed_upload_mimes() {
        ...
        return apply_filters( 'n8lc_allowed_upload_mimes', $mimes );
    }
}
